...
public class MayMoc {
    ...
    public MayMoc(int maMay, String tenMay, String loaiMay, String ngayNhap, String tinhTrang, String moTa, String anhMayMoc, double giaBan, String trangThaiHienThi) {
        this.maMay = maMay;
        this.tenMay = tenMay;
